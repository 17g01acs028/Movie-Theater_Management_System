             ...
             <div class="container_form">
               ...
               <div class="row">
                 ...
                 <div class="col">
                   ...
                   <div class="input-box">
                     <span>Name</span>
                     <input type="text" placeholder="Hall Name" readonly name="name" id="name" value="<?php echo $user['Name']?>">
                   </div>
                 ...
                 <div class="input-box">
                     <span>Seats</span>
                     <input type="text" placeholder="Seats" name="seat" id="seat" readonly value="<?php echo $user['Seats']?>">
                   </div>
                  <?php }?>

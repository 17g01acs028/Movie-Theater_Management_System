               ...
               <div class="row">
                 ...
                 <div class="col">
                   ...
                   <div class="input-box">
                     ...
                     <input type="text" placeholder="07xxxxxxx or 01xxxxxxx" name="phone" id="phone">
                   </div>
                ...
                <input type="hidden" id="save_user" valu="save_user">
                <input type="submit" value="Save" class="submit-btn" name="save_user">
                 </form>
               </div>
...
form.addEventListener("submit", (error)=>{
    ...
    var form_data = new FormData();
      ...
      form_data.append('save_user',save_user.value);	

...
<div class="alert hide">
		 <div class="ex">
		 <span>!</span></div>
		 <span class="msg" id="global_msg">New Hall Added</span>
             ...
             <div class="container_form">
               ...
               <div class="row">
                 ...
                 <div class="col">
                   ...
                   <div class="input-box">
                     <span>Name</span>
                     <input type="text" placeholder="Hall Name" name="name" id="name">
                   </div>
                   <div class="input-box">
                     <span>columns</span>
                     <input type="text" placeholder="Columns" name="col" id="col">
                   </div>
                 ...
                 <div class="input-box">
                     <span>Seats</span>
                     <input type="text" placeholder="Seats" name="seat" id="seat">
                   </div>
...
form.addEventListener("submit", (error)=>{
    ...
    var form_data = new FormData();
      ...
      form_data.append('save_hall',"new_hall");

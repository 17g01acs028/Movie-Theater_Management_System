<?php include('components/body.php');?>
    <div class="content">
      ...
      <h2>Dashboard/View Movie Schedule</h2>
               ...
               <div class="row">
                 ...
                 <div class="col">
                   ...
                   <div class="input-box">
                     ...
                     <select name="movie1" id="" disabled>
                     <?php
                    $count =1;
                   ...
                   <div class="input-box">
                     ...
                     <input type="date" placeholder="dd-mm-yyyy" name="date" value="<?php echo $schedule['date']?>" readonly>
                   </div>
                   <div class="input-box">
                     <span>Enter Date out</span>
                     <input type="date" placeholder="dd-mm-yyyy" name="date1" value="<?php echo $schedule['date1']?>" readonly>
                   </div>
                 </div>
                 <div class="col">
                 <div class="input-box">
                     <span>Select Hall</span>
                     <select name="hall" id="" disabled>
                     <?php
                    $count =1;
                 ...
                 <div class="input-box">
                     ...
                     <input type="time" placeholder="00:00:00" name="time" value="<?php echo $schedule['time']?>" readonly>
                   </div>
                   <div class="input-box">
                     <span>Enter Time out</span>
                     <input type="time" placeholder="00:00:00" name="time1" value="<?php echo $schedule['time1']?>" readonly>
                   </div>

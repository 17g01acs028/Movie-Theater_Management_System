        ...
        <div class="recent_rating">
             ...
             <div class="container_form">
               ...
               <input type="hidden" name="save_id" value="<?php echo $movie_img['Un_id'];?>">
                 ...
                 <div class="input-box">
                   ...
                   <div class="input-box">
                     ...
                     <input type="text" placeholder="Example 5" name="ticket" value="<?php echo count($_SESSION['seats'])?>" readonly>
                   </div>
                 </div>
               ...
               <script
                ...
                data-key="pk_test_51KKNH8LTMjTVSXPxogruLpAH7xe8RJxbwQhTBqLtyrSu33Dv1vEnqvPPBMIK8hSgVSswBrQ6IHgdAzakUUXixRYd009Kgb5Nu9"
                data-amount=<?php echo str_replace(",","",$movie_img['price'] *count($_SESSION['seats'])) * 100?>
                data-name="<?php echo $mv_img['mname']?>"
                data-description="<?php echo $mv_hall['Name']?>"
                data-image="<?php ?>"
                data-currency="kes"
                data-locale="auto">
                </script>
